...
def read_graph(g, filename):
            with open(filename, "r") as f:
                for line in f:
                    # print(line)
                    source, target = line.strip().split()  # Assuming edges are space-separated
...
if __name__ == "__main__":
    ...
    for file in filelist:
        ...
        # =======================NetworkX=======================
        if file in ['ca-CondMat_lcc.txt', 'email-Enron_lcc.txt']:
            ...
            print("=================")
            print()
            benchmark('read_graph(nx.Graph(), filename)', globals=globals(), n=n)
