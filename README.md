...
For different types of network, we compare a series of network analysis functions including:
...
get_lcc_edgelist.py // tool for getting the largest connnected components of each dataset
profile_directed_hp_er.py   // bench on directed random networks generated by Erdos random network model with hybrid programming
profile_directed_hp_rw.py   // bench on directed real-world networks generated by Erdos random network model with hybrid programming
profile_directed_mp_rw.py		//  bench on directed real-world networks with multiprocessing techniques
profile_directed_mp_er.py 	//  bench on directed random networks generated by Erdos random network with multiprocessing techniques
profile_undirected_hp_er.py  //  bench on undirected random networks generated by Erdos random network with hybrid programming
...
1. Open your terminal, make sure you have entered into right python environment that equipped with EasyGraph and the igraph library. 
