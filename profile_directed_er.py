...
if __name__ == "__main__":
    ...
    for size in n_sizelist:
        ...
        print("multi_source_dijkstra:",multi_source_dijkstra(g, sources = eg_node_list))
        print("multi_source_dijkstra(g, sources = eg_node_list):",multi_source_dijkstra(g, sources = eg_node_list))
        ...
        benchmark('g.betweenness(directed=True,weights=[1]*len(g.edges))', globals=globals(), n=n)
        ...
        print("ig_node_list:",ig_node_list)
